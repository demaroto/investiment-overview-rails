...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { email: @contato.email, mensagem: @contato.mensagem, nome: @contato.nome, pontuacao: @contato.pontuacao } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { email: @contato.email, mensagem: @contato.mensagem, nome: @contato.nome, pontuacao: @contato.pontuacao } }
